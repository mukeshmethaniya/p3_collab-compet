...
For this project, we used multipal agent for predicting action and playing game against each other in the Unity environment.
...
- Find Existing training weight in 'checkpoint_actor.pth' and 'checkpoint_critic.pth' for Actor and Critic neural network respectively
